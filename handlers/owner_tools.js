...
exports.trySmartUpload = async (ctx) => {
  ...
  const regex = /تخصص:|سنة:|فصل:|مادة:|قسم:|spec:|year:|sem:|mat:|cat:|spé|année|semestre|matière|catégorie/i;
  ...
  if(parts.length < 5) { return ctx.reply('صيغة غير مكتملة. مثال:\nتخصص: LMD | سنة: 2 | فصل: 1 | مادة: Algo | قسم: Serie'); }
...
exports.batchPromote = async (ctx) => {
  ...
  if(!ids.length) return ctx.reply('استخدم: /promote ID1 ID2');
  let done = 0;
